...
// SQL Query
$to_all = "all";
$sql = "SELECT * FROM inbox WHERE to_id = '".$to_all."' AND from_id = '".$_SESSION['user_name']."' ORDER BY send_date DESC LIMIT 0, 10";
...
?>
	...
	<a href="admin_inbox_recurring.php?id=<?php echo $row["id"];?>">
		<div class="mail_list">
			<div class="left">
