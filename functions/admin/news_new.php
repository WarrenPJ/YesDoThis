...
mysqli_query($connection, "INSERT INTO news 
(`title`, `description`, `image`, `category`, `date`, `post_url`, `active`) VALUES ('".$title."','".$description_html."','".$image."','".$category."',now(),'".$unique_slug."','".$active."')");
...
mysqli_query($connection, "INSERT INTO news 
(`title`, `description`, `image`, `category`, `date`, `post_url`, `active`) VALUES ('".$title."','".$description_html."','".$image."','".$category."',now(),'".$slug."','".$active."')");
...
?>
	<script type='text/javascript'>
		window.location = "admin_news_edit.php?id=<?php echo $last_id; ?>";
	</script>
	<?php
}
//End update records
