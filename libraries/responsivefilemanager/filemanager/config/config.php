...
$config = array(
	...
	*/
	...
	| root = 'Admin';
	|  = 'dsflFWR9u2xQa' (a hard coded string)
	|  = md5(root.);
	...
	*/
	...
	'access_keys' => array('yoursecurekey'),
	...
	*/
	...
	//convert all spaces on files name and folders name with  variable
	...
	*/
	...
	//Automatic resizing //
	// If you set  to TRUE the script converts all uploaded images exactly to image_resizing_width x image_resizing_height dimension
	// If you set width or height to 0 the script automatically calculates the other dimension
	// Is possible that if you upload very big images the script not work to overcome this increase the php configuration of memory and time limit
	'image_resizing'                          => false,
	'image_resizing_width'                    => 0,
	'image_resizing_height'                   => 0,
	'image_resizing_mode'                     => 'auto', // same as 
	'image_resizing_override'                 => false,
	// If set to TRUE then you can specify bigger images than  & height otherwise if image_resizing is
	// bigger than  or height then it will be converted to those values
	...
	'create_text_files'                       => false, // only create files with exts. defined in 

	// you can preview these type of files if  is true
	'previewable_text_file_exts'              => array( 'txt', 'log', 'xml', 'html', 'css', 'htm', 'js' ),
	'previewable_text_file_exts_no_prettify'  => array( 'txt', 'log' ),

	// you can edit these type of files if  is true (only text based files)
	// you can create these type of files if  is true (only text based files)
