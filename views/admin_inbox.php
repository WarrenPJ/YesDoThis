		...
		<div class="">
			...
			<div class="page-title">
				<div class="title_left">
					<h3>Email Inbox <small>Send messages to your users</small></h3>
				</div>
...
//echo $row_last['id'];
   ...
   ?>
					...
					echo $row_last['id'];
					echo '" class="btn btn-sm btn-primary btn-block">';
					?>
   ...
   ?>
											...
											<?php 
									include 'functions/admin/inbox_latest_messages.php';
									?>
								...
								<div class="col-sm-9 mail_view">
									...
									<?php 
									include 'functions/admin/inbox_overview.php';
									?>
