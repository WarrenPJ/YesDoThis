...
mysqli_query($connection, "INSERT INTO pages 
(`title`, `description`, `post_url`, `active`) VALUES ('".$title."','".$description_html."','".$unique_slug."','".$active."')");
...
mysqli_query($connection, "INSERT INTO pages 
(`title`, `description`, `post_url`, `active`) VALUES ('".$title."','".$description_html."','".$slug."','".$active."')");
...
?>
	<script type='text/javascript'>
		window.location = "admin_pages_edit.php?id=<?php echo $last_id; ?>";
	</script>
	<?php
}
