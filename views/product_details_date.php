...
?>
	<script type='text/javascript'>
		window.location = "<?php echo $url; ?>/product_details_edit.php?id=<?php echo $_GET['id']; ?>";
	</script>
	<?php
}}}		
...
<script>
	$(document).ready(function(){
     ...
     <!-- <input type="submit" name="submit" id="submit" value="Save your project" class="btn btn-info pull-right">-->
			 <input type="submit" name="submit_btn_personal_details" value="Save and go back" class="btn btn-info pull-right" />
    </div>
  </form>
