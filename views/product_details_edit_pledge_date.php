...
?>
	<script type='text/javascript'>
		window.location = "product_details_edit_pledge_image.php?id=<?php echo $_GET['id']; ?>&user=<?php echo $row_user_details['user_id']; ?>&product=<?php echo $_GET['product']; ?>";
	</script>
	<?php
}}
...
<script>
	$(document).ready(function(){
     ...
     <!-- <input type="submit" name="submit" id="submit" value="Save your project" class="btn btn-info pull-right">-->
			 <input type="submit" name="submit_btn_personal_details" value="Save and move to your reward image" class="btn btn-info pull-right" />
    </div>
  </form>
